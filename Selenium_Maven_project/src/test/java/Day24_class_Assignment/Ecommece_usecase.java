package Day24_class_Assignment;
import java.io.File;
...
public class Ecommece_usecase{
 ...
 driver.findElement(By.id("userName")).sendKeys("Eklavya");
 Thread.sleep(2000);
 driver.findElement(By.id("currentAddress")).sendKeys("Banka bihar");
 driver.findElement(By.id("permanentAddress")).sendKeys("Banka bihar");
 driver.findElement(By.id("userEmail")).sendKeys("eklavya@gmail.com");
 Thread.sleep(2000);
